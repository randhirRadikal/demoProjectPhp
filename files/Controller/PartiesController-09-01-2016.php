...
class PartiesController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            $data['address_line_2'] = isset($data['address_line_2'])?$data['address_line_2']:'1';
            $conn = ConnectionManager::get('default');
            $query = "call sp_add_user_details('".$data['first_name']."','".$data['last_name']."','".$data['email']."','".$data['password']."','".$data['last_name']."','".$data['latLng']['lat']."','".$data['latLng']['lng']."','".$data['middle_name']."','".$data['address_line_1']."','".$data['address_line_2']."','".$data['city']."','".$data['zipcode']."','".$data['country']."');";
